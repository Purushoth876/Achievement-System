                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    include('AbstractFactory.php');
                                        $factory = new Factory();
                                        $category = $factory->getStudentsRecord();
                                        $data = $category->authUsers($_SESSION['regno']);
                                    ?>
                                    <li class="user-header bg-light-blue">
                                        <img src="<?php echo "profile_pic/" . $_SESSION['pic']; ?>" class="img-circle" alt="User Image" />
                                        <p>
                                            <?php echo $data['name']; ?>
                                            <small><?php echo $data['school']; ?></small>
                                        </p>
                                    </li>
