...
<html>
    <head>
        <meta charset="UTF-8">
        <?php session_start(); ?>
        <title><?php "Welcome " . $_SESSION['name']; ?></title>
                        ...
                        <center>
                            <table>
                                ...
                                <tr><td><label>Post</label></td>
                                    <td><textarea rows="6" cols="21" name="post"></textarea></td></tr>
                                <tr><td><input type="submit" name="submit" value="Post"/></td>
